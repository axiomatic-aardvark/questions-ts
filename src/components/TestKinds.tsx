    ...
    return (
        <>
            ...
            <div className="choose-kinds-wrapper">
                ...
                <span className={`${chosen.includes("dihatelna") ? "selected" : ""}`} onClick={() => clickKind("dihatelna")}>Дихателна система</span>
                <span className={`${chosen.includes("hranosmilatelna") ? "selected" : ""}`} onClick={() => clickKind("hranosmilatelna")}>
                    Храносмилателна система
                </span>
                <span className={`${chosen.includes("obmqna-na-veshtestvata") ? "selected" : ""}`} onClick={() => clickKind("obmqna-na-veshtestvata")}>
                    Обмяна на веществата
                </span>
                <span className={`${chosen.includes("obmqna-na-energiqta") ? "selected" : ""}`} onClick={() => clickKind("obmqna-na-energiqta")}>
                    Обмяна на енергията
                </span>
                <span className={`${chosen.includes("otdelitelna") ? "selected" : ""}`} onClick={() => clickKind("otdelitelna")}>Отделителна система</span>
                <span className={`${chosen.includes("endokrinna") ? "selected" : ""}`} onClick={() => clickKind("endokrinna")}>Ендокринна система</span>
                <span className={`${chosen.includes("muzhka-i-zhenska") ? "selected" : ""}`} onClick={() => clickKind("muzhka-i-zhenska")}>
                ...
                <span className={`${chosen.includes("setivni-sistemi") ? "selected" : ""}`} onClick={() => clickKind("setivni-sistemi")}>Сетивни системи</span>
                <span className={`${chosen.includes("regulaciq") ? "selected" : ""}`} onClick={() => clickKind("regulaciq")}>Регулация на движение</span>
