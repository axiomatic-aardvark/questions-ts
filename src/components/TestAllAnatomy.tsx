...
import QuestionViewAnatomy from "./QuestionsAllAnatomy";

export default function TestAllAnatomy() {
        ...
        questions.length > 0 ? (
            <>
                ...
                <div className="question-container">
                    <QuestionViewAnatomy context={shuffle(questions)[0]} cache={questions}/>
